...
"icon": {"color": "blak", "font-size": "14px", "margin":"0px"}, 
"nav-link": {"color": "blak!important","font-size": "18px", "text-align": "left", "padding": "5px!important", "margin":"0px", "--hover-color": "#eee"},
